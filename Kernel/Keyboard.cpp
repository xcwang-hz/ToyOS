...
{
    byte ch = scancode & 0x7f;
    bool pressed = !(scancode & 0x80);

#ifdef KEYBOARD_DEBUG
    dbgprintf("Keyboard::handle_scancode: %b %s\n", ch, pressed ? "down" : "up");
#endif
    switch (ch) {
    case 0x38: 
        update_modifier(Mod_Alt, pressed); break;
    case 0x1d: 
        update_modifier(Mod_Ctrl, pressed); break;
    case 0x2a: 
    case 0x36: 
        update_modifier(Mod_Shift, pressed); break;
